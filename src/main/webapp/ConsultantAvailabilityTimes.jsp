...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h4 class="text-center">Availability Times</h4>
      <div class="table-responsive text-center justify-self-center">
        ...
        <table class="table table-striped">
		  ...
		  <tbody>
		   <tag:forEach var="time" items="${availabilityTimes}">
		    <tr>
		      <th scope="row">${time.availabilityTimeId}</th>
		      <td style="text-align: center !important;">${time.date}</td>
		      <td>${time.time}</td>
