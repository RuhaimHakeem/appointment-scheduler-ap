...
<section class="vh-100">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-8 col-lg-6 col-xl-4">
    	<h3 class="text-center mb-4" style="color:#424C49;">Consultant Login</h3>
        ...
        <form>
          ...
          <div class="text-center mt-4 pt-2">
            ...
            <p style="color:#424C49;" class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="ConsultantRegister.jsp"
